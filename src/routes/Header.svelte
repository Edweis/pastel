...
<header class="top-0 left-0 right-0 fixed max-w-6xl mx-auto z-50">
	<nav
		class="relative border-[0.5px] shadow-lg transition-all duration-700 items-center border-gray-500 shadow-black/40   bg-dark rounded-lg text-white mt-4 p-4 flex justify-between"
		class:border-dark={scrollY === 0}
		class:shadow-none={scrollY === 0}
	>
		<a href="/" class="text-2xl">Pastel</a>
		<ul class="grid grid-flow-col gap-4 text-xl font-light">
			<li class="group">
				<a href="/why" class={underlineAfter + " after:bg-indigo-500 "}
					>Why Pastel</a
				>
				<MenuWhy class="visible group-hover:visible hover:visible" />
			</li>
			<li>
				<a
					href="/solutions"
					class={underlineAfter + " after:bg-orange-500 "}
					>Solutions</a
				>
				<!-- <MenuSolution /> -->
			</li>
			<li>
				<a
					href="/resources"
					class={underlineAfter + " after:bg-green-500 "}>Resources</a
				>
				<!-- <MenuResources /> -->
			</li>
			<li>
				<a
					href="/pricing"
					class={underlineAfter + " after:bg-yellow-500 "}>Pricing</a
				>
				<!-- <MenuPricing /> -->
			</li>
		</ul>
